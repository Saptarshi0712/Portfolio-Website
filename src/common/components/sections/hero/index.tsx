        ...
        <div className="container flex flex-col items-start justify-center tracking-wide text-black dark:text-white">
          <div className="container relative flex h-full w-full flex-col items-center">
            <div className="text-white h-72 w-[280px] text-center text-[2rem] font-extrabold sm:w-[520px] md:w-[700px] lg:mb-5 lg:w-[920px] lg:text-[3rem]">
              ...
              <br />
              <TextAnimation delay={1} baseText={`I'm Saptarshi Pattanayak`} />
            </div>
            <motion.div
            ...
            >
              ...
              <a
                ...
                href="https://drive.google.com/file/d/1m07AvLIfWcmN1WrhrEBuJpU-wxItTfwZ/view?usp=sharing"
                download
              >
              ...
              <div className="flex gap-2">
                <a
                  ...
                  href="https://www.linkedin.com/in/saptarshi-pattanayak-a97255252/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a
                  ...
                  href="https://github.com/Saptarshi0712"
                  target="_blank"
                >
                  <AiOutlineGithub />
                </a>
